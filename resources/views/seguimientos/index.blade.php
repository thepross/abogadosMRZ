            ...
            <div class="card mb-4">
                <div class="card-header pb-0">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="btn btn-success ms-auto" type="button" href="{{ route('seguimientos.create') }}"><i
                                class="fa fa-plus"></i> Registrar Seguimiento</a>
                    </div>
                </div>
                                    ...
                                    @foreach ($seguimientos as $seguimiento)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center text-sm">
                                                ...
                                                <form action="{{ route('seguimientos.destroy', [$seguimiento->id]) }}"
